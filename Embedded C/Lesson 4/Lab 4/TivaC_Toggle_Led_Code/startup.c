...
uint32 stack_top[256];

/*
// ANOTHER SOLUTION
 

static uint32 vectors[] __attribute__((section(".vectors"))) ={
	(uint32) ((uint32)stack_top + sizeof(stack_top)),
...
void(*const g_p_f_u[])() __attribute__((section(".vectors"))) =
{
