...
void MCAL_USART_GPIO_SetPins(USART_TypeDef* USARTx)
{
	...
	{
		//TX:PA9
		GPIO_PinConfig_t GPIO_USART1_PinCFG;
		GPIO_USART1_PinCFG.GPIO_PINNumber=GPIO_PIN9;
		GPIO_USART1_PinCFG.GPIO_Mode=GPIO_Mode_AF_OUT_PP;
		GPIO_USART1_PinCFG.GPIO_Speed=GPIO_Speed_10MHZ;
		MCAL_GPIO_init(GPIOA, &GPIO_USART1_PinCFG);
		//RX:PA10
		GPIO_USART1_PinCFG.GPIO_PINNumber=GPIO_PIN10;
		GPIO_USART1_PinCFG.GPIO_Mode=GPIO_Mode_IN_Float;
		MCAL_GPIO_init(GPIOA, &GPIO_USART1_PinCFG);
		//CTS:PA11
		GPIO_USART1_PinCFG.GPIO_PINNumber=GPIO_PIN11;
		GPIO_USART1_PinCFG.GPIO_Mode=GPIO_Mode_IN_Float;
		MCAL_GPIO_init(GPIOA, &GPIO_USART1_PinCFG);
		//RTS:PA12
		GPIO_USART1_PinCFG.GPIO_PINNumber=GPIO_PIN12;
		GPIO_USART1_PinCFG.GPIO_Mode=GPIO_Mode_AF_OUT_PP;
		GPIO_USART1_PinCFG.GPIO_Speed=GPIO_Speed_10MHZ;
		MCAL_GPIO_init(GPIOA, &GPIO_USART1_PinCFG);
	}
	...
	{
		//TX:PA2
		GPIO_PinConfig_t GPIO_USART2_PinCFG;
		GPIO_USART2_PinCFG.GPIO_PINNumber=GPIO_PIN2;
		GPIO_USART2_PinCFG.GPIO_Mode=GPIO_Mode_AF_OUT_PP;
		GPIO_USART2_PinCFG.GPIO_Speed=GPIO_Speed_10MHZ;
		MCAL_GPIO_init(GPIOA, &GPIO_USART2_PinCFG);
		//RX:PA3
		GPIO_USART2_PinCFG.GPIO_PINNumber=GPIO_PIN3;
		GPIO_USART2_PinCFG.GPIO_Mode=GPIO_Mode_IN_Float;
		MCAL_GPIO_init(GPIOA, &GPIO_USART2_PinCFG);
		//CTS:PA0
		GPIO_USART2_PinCFG.GPIO_PINNumber=GPIO_PIN0;
		GPIO_USART2_PinCFG.GPIO_Mode=GPIO_Mode_IN_Float;
		MCAL_GPIO_init(GPIOA, &GPIO_USART2_PinCFG);
		//RTS:PA1
		GPIO_USART2_PinCFG.GPIO_PINNumber=GPIO_PIN1;
		GPIO_USART2_PinCFG.GPIO_Mode=GPIO_Mode_AF_OUT_PP;
		GPIO_USART2_PinCFG.GPIO_Speed=GPIO_Speed_10MHZ;
		MCAL_GPIO_init(GPIOA, &GPIO_USART2_PinCFG);
	}
	...
	{
		//TX:PB10
		GPIO_PinConfig_t GPIO_USART3_PinCFG;
		GPIO_USART3_PinCFG.GPIO_PINNumber=GPIO_PIN10;
		GPIO_USART3_PinCFG.GPIO_Mode=GPIO_Mode_AF_OUT_PP;
		GPIO_USART3_PinCFG.GPIO_Speed=GPIO_Speed_10MHZ;
		MCAL_GPIO_init(GPIOB, &GPIO_USART3_PinCFG);
		//RX:PB11
		GPIO_USART3_PinCFG.GPIO_PINNumber=GPIO_PIN11;
		GPIO_USART3_PinCFG.GPIO_Mode=GPIO_Mode_IN_Float;
		MCAL_GPIO_init(GPIOB, &GPIO_USART3_PinCFG);
		//CTS:PB13
		GPIO_USART3_PinCFG.GPIO_PINNumber=GPIO_PIN13;
		GPIO_USART3_PinCFG.GPIO_Mode=GPIO_Mode_IN_Float;
		MCAL_GPIO_init(GPIOB, &GPIO_USART3_PinCFG);
		//RTS:PB14
		GPIO_USART3_PinCFG.GPIO_PINNumber=GPIO_PIN14;
		GPIO_USART3_PinCFG.GPIO_Mode=GPIO_Mode_AF_OUT_PP;
		GPIO_USART3_PinCFG.GPIO_Speed=GPIO_Speed_10MHZ;
		MCAL_GPIO_init(GPIOB, &GPIO_USART3_PinCFG);
	}
