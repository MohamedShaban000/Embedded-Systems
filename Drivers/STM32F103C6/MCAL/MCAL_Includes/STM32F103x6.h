...
#define RCC_USART2_CLOCK_EN() 	(RCC->APB2ENR |= 1<<17)
#define RCC_USART3_CLOCK_EN() 	(RCC->APB2ENR |= 1<<18)
...
//USART
#define NVIC_USART1_IRQ_EN()		(NVIC_ISER1 |= (5));
#define NVIC_USART2_IRQ_EN()		(NVIC_ISER1 |= (6));
#define NVIC_USART3_IRQ_EN()		(NVIC_ISER1 |= (7));
...
//USART
#define NVIC_USART1_IRQ_Disable()			(NVIC_ICER1 |= (5));
#define NVIC_USART2_IRQ_Disable()			(NVIC_ICER1 |= (6));
#define NVIC_USART3_IRQ_Disable()			(NVIC_ICER1 |= (7));
